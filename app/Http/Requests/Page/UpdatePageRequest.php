...
class UpdatePageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'deleted_sections_ids' => ['nullable', 'array'],
        ...
        foreach ($locales as $locale) {
            ...
            $rules["name.{$locale}"] = [
                ...
                'string',
                'max:255',
                Rule::unique('pages', "name->{$locale}")->ignore($this->page, 'slug')
            ];
        ...
        $rules['sections.*.id'] = ['nullable', 'integer', Rule::exists('sections', 'id')];
        ...
        $rules = array_merge($rules, [
            ...
            'sections.*.subsections.*.id' => ['nullable', 'integer', Rule::exists('sections', 'id')],
