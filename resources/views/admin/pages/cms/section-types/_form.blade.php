<div class="row">
    <div class="col-md-12 mb-3">
        <div class="form-floating form-floating-outline">
            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                value="{{ old('name', $sectionType->name ?? null) }}" required>
    ...
    <div class="col-md-12 mb-3">
        <div class="form-floating form-floating-outline">
            <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                name="description" rows="3">{{ old('description', $sectionType->description ?? null) }}</textarea>
            ...
            @foreach($fieldOptions as $field)
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="fields[]" value="{{ $field }}"
                        id="field_{{ $field }}" {{ in_array($field, $currentFields, true) ? 'checked' : '' }}>
    ...
    <div class="col-md-12 mb-3">
        ...
        @if(!empty($sectionType?->id) && $sectionType->getFirstMediaUrl('image'))
            <div class="mb-2">
                <img src="{{ $sectionType->getFirstMediaUrl('image') }}" alt="Current image"
