...
@section('title', __('custom.titles.partners'))
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <div class="row align-items-end">
                    <div class="d-flex align-items-end justify-content-end">
                        ...
                        @can('partner.create')
                            <div id="" class="">
                                <a href="{{ route('dashboard.partners.create') }}" class="dt-button add-new btn btn-primary"
                                    tabindex="0" aria-controls="DataTables_Table_0" type="button">
                                    <span>
                                        <i class="mdi mdi-plus me-0 me-sm-1"></i>
                                        <span
                                            class="d-none d-sm-inline-block">{{ __('custom.words.add') . ' ' . __('custom.partner.partner') }}</span>
                                    </span>
                                </a>
                            </div>
                        @endcan
                            ...
                            <div class="dropdown-menu" style="">
                                ...
                                @can('partner.delete')
                                    <a class="dropdown-item waves-effect delete-selection"
                                        data-url="{{ route('dashboard.partners.delete') }}" data-bs-toggle="modal"
            ...
            <div class="table-responsive table-data" id="user-list">
                @include('admin.pages.partners.table')
            </div>
        </div>
    </div>

    @include('admin.pages.partners.partials.__filter_date_modal')

    @include('admin.pages.partners.partials.__import_modal')
