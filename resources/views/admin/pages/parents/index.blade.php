...
@section('title', __('custom.titles.parents'))
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <div class="row align-items-end">
                    <div class="d-flex align-items-end justify-content-end">
                        ...
                        @can('parent.create')
                            <div id="" class="">
                                <a href="{{ route('dashboard.parents.create') }}" class="dt-button add-new btn btn-primary"
                                    tabindex="0" aria-controls="DataTables_Table_0" type="button">
                                    <span>
                                        <i class="mdi mdi-plus me-0 me-sm-1"></i>
                                        <span
                                            class="d-none d-sm-inline-block">{{ __('custom.words.add') . ' ' . __('custom.parent.parent') }}</span>
                                    </span>
                                </a>
                            </div>
                        @endcan
                            ...
                            <div class="dropdown-menu" style="">
                                @can('parent.delete')
                                    <a class="dropdown-item waves-effect delete-selection"
                                        data-url="{{ route('dashboard.parents.delete.multiple') }}" data-bs-toggle="modal"
            ...
            <div class="table-responsive table-data" id="parent-list">
                @include('dashboard.pages.parents.table')
            </div>
        </div>
    </div>
