...
@section('title', __('custom.words.create_new') . ' ' . __('custom.student.student'))
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h4>{{ __('custom.words.create_new') . ' ' . __('custom.student.student') }}</h4>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-floating form-floating-outline">
                                <input id="academicYearInput" class="form-control" type="text" name="academic_year"
                                    value="{{ old('academic_year') }}" placeholder="2023-2024">
