...
@section('title', __('custom.titles.students'))
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <div class="row align-items-end">
                    <div class="d-flex align-items-end justify-content-end">
                        ...
                        @can('student.create')
                            <div id="" class="">
                                <a href="{{ route('dashboard.students.create') }}" class="dt-button add-new btn btn-primary"
                                    tabindex="0" aria-controls="DataTables_Table_0" type="button">
                                    <span>
                                        <i class="mdi mdi-plus me-0 me-sm-1"></i>
                                        <span
                                            class="d-none d-sm-inline-block">{{ __('custom.words.add') . ' ' . __('custom.student.student') }}</span>
                                    </span>
                                </a>
                            </div>
                        @endcan
                            ...
                            <div class="dropdown-menu" style="">
                                @can('student.delete')
                                    <a class="dropdown-item waves-effect delete-selection"
                                        data-url="{{ route('dashboard.students.delete.multiple') }}" data-bs-toggle="modal"
            ...
            <div class="table-responsive table-data" id="student-list">
                @include('dashboard.pages.students.table')
            </div>
        </div>
    </div>
