...
@section('title', __('custom.words.edit') . ' ' . __('custom.project.project'))
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('dashboard.projects.update', $data['record']->slug) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="form-floating form-floating-outline">
                                <input id="dateInput" class="form-control" type="date" name="date"
                                    value="{{ old('date', $data['record']->date ? $data['record']->date->format('Y-m-d') : '') }}">
