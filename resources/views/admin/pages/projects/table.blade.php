<table class="table">
    ...
    <tbody>
        @foreach ($data['data']['data'] as $project)
            <tr>
                <td>
                    <input type="checkbox" class="form-check-input checkboxInput" value="{{ $project->id }}">
                </td>
                <td>{{ $project->name }}</td>
                <td>{{ $project->slug }}</td>
                <td>{{ $project->status->lang() }}</td>
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" style="">
                            @can('project.edit')
                                <a class="dropdown-item waves-effect"
                                    href="{{ route('dashboard.projects.edit', $project->slug) }}">
                            ...
                            @can('project.delete')
                                <a class="dropdown-item waves-effect delete-btn" href="#" data-bs-toggle="modal"
                                    ...
                                    data-url="{{ route('dashboard.projects.destroy', $project->slug) }}"><i
