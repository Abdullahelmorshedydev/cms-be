...
<head>
    ...
    <title>{{ __('custom.500.title') }}</title>
...
<body>
    ...
    <div class="misc-wrapper">
        <h3 class="mb-2 mx-2">{{ __('custom.500.header') }}! 🚧</h3>
        <p class="mb-4 mx-2">{{ __('custom.500.description') }}</p>
        <div class="d-flex justify-content-center mt-5">
            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <div>
                    <a href="{{ url('/') }}" class="btn btn-primary text-center my-5">{{__('custom.words.back_to_home')}}</a>
                </div>
            </div>
        </div>
    </div>
