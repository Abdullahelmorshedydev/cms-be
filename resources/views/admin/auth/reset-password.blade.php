            ...
            <div class="authentication-inner row m-0">
                ...
                <div
                    ...
                    <div class="w-px-400 mx-auto pt-5 pt-lg-0">
                        <h4 class="mb-2">{{ __('custom.reset_password.title') }} 🔒</h4>
                        <p class="mb-4">{{ __('custom.reset_password.header') }}</p>
                        <form id="formAuthentication" class="mb-3" action="{{ route('dashboard.reset_password') }}"
                            ...
                            <div class="mb-3 form-password-toggle">
                                <div class="input-group input-group-merge">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        <label for="password">{{ __('custom.inputs.new_password') }}</label>
                                        @error('password')
                                ...
                                <div class="input-group input-group-merge">
                                    <div class="form-floating form-floating-outline">
                                        <input type="password" id="confirm-password" class="form-control"
                                            ...
                                            aria-describedby="password" />
                                        <label
                                            for="confirm-password">{{ __('custom.inputs.new_password_confirmation') }}</label>
                            ...
                            <button class="btn btn-primary d-grid w-100 mb-3">{{ __('custom.words.set_new_password') }}</button>
